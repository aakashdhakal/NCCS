...
// // CardLayout Panel (with buttons to switch cards)
...
// JPanel cardControlPanel = new JPanel();
// JButton nextBtn = new JButton("Next Card");
// cardControlPanel.add(nextBtn);
// JPanel cardLayoutPanel = new JPanel(new BorderLayout());
// cardLayoutPanel.add(cards, BorderLayout.CENTER);
// cardLayoutPanel.add(cardControlPanel, BorderLayout.SOUTH);
// nextBtn.addActionListener(e -> cardLayout.next(cards));
...
// layoutCombo.addActionListener(e -> cardLayout.show(cardPanel, (String)
// layoutCombo.getSelectedItem()));

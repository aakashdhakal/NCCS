...
abstract class Vehicle {
    ...
    public void showInfo() {
        System.out.println(getClass().getSimpleName() + " - " + make + " " + model + " (" + year + "), Fuel: " + fuelType);
    }
}
...
class Truck extends Vehicle {
    ...
    @Override
    public double fuelEfficiency() { return 5.0; }
    @Override
    public double maxSpeed() { return 120.0; }
}
...
class Car extends Vehicle {
    ...
    @Override
    public double fuelEfficiency() { return 15.0; }
    @Override
    public double maxSpeed() { return 180.0; }
}
...
class Motorcycle extends Vehicle {
    ...
    @Override
    public double fuelEfficiency() { return 35.0; }
    @Override
    public double maxSpeed() { return 140.0; }
}

public class Gaadi {
    public static void main(String[] args) {
        Vehicle[] vehicles = {
                new Truck("Tata", "LPT", 2020, "Diesel"),
